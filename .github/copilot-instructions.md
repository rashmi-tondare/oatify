...
**Problem Statement:** Choosing what to make for overnight oats every morning is a small but repetitive decision that
leads to either decision fatigue or falling back on the same recipe. There's no fun, frictionless way to discover and
rotate through curated overnight oat recipes.

**Proposed Solution:** Oatify — a single-page static website styled as a slot machine that randomly selects from 10
curated overnight oat recipes. Four emoji reels (Liquid, Fruit, Crunch, Oomph) spin and land on a cohesive recipe,
revealing a full ingredient card below.
...
- [x] The footer contains a disclaimer stating that recipes are suggestions and users should consider their own dietary
